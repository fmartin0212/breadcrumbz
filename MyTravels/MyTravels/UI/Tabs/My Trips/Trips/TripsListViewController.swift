...
//        updateProfilePicture()
        TripController.shared.share(trip: TripController.shared.trips[0]
        , withReceiver: "fmartjn0212") { (_) in
            
        }
        
//        InternalUserController.shared.blockUserWith(username: "fmartjn0212") { (success) in
//
//        }
